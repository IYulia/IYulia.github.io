...
function createWeather(country, weatherData) {
    ...
    const html = `<h1 class="weatherTitel">${country}</h1>
...
//     const apiKey = '291f69f3a9ed49979d4e3cfb59f7dec9';
//     const days = 7;
//         const weatherUrl = `https://api.weatherbit.io/v2.0/forecast/daily?key=${apiKey}lat=${lat}&lon=${lon}&days=${days}`;

//         const weatherResponse = await fetch(weatherUrl);
//         const weatherData = await weatherResponse.json();

//         console.dir(countryInput)
